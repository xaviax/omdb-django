...
class OmdbMovie:
  """
  this class represents movie data coming back 
  from OMdb and transform to Python types 
  """
...
class OmdbClient:
  ...
  def search(self,search):
    ...
    this is a generator so all results from all pages
    will be iterated across."""
